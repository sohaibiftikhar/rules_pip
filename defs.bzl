...
def _pip_import_impl(repository_ctx):
    ...
    extra_build_info_json = struct(build_files = repository_ctx.attr.extra_build_files, build_targets = repository_ctx.attr.extra_build_targets).to_json()
...
Additional targets that the extra build file declares. Adding this creates and alias for
